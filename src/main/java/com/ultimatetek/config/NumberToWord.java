/**
Author: Md Jamil Ashraf, Md-Naushad, Syed Adil
Created Date: Mar 19, 2020
Copyright © 2019, Ultimatetek Solutions. All rights reserved.
*/
package com.ultimatetek.config;

public class NumberToWord {
	public static String convertToWord(String number1) {
		
	//	String numbers[] = number1.split(".");
		
		String number = number1.substring(0, number1.indexOf("."));
