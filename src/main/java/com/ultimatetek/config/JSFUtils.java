...
public class JSFUtils {
    ...
    public static void removeSessionBean(String beanName){
         Map<String, Object> map=JSFUtils.getFacesContext().getExternalContext().getSessionMap();
         map.remove(beanName);
    }
    /**
    ...
    public static String resolveRemoteUser() {
        ...
        HttpServletRequest hreq = (HttpServletRequest) ectx.getRequest();
        return hreq.getRemoteHost();
    }
// public static String resolveRemoteHost(){
//      FacesContext facesContext = getFacesContext();
//        ExternalContext ectx = facesContext.getExternalContext();
//        return ectx.getR;
// }
    ...
    public static String getStringFromBundle(String key,Object[] messageArguments) {
        ResourceBundle bundle = getBundle();
        String temp= getStringSafely(bundle, key, null);
    ...
    //     * @param msg error message string
    //     */
    //    public static void addFacesErrorMessage(String attrName,String summary,String dtl) {
    //        FacesContext ctx = getFacesContext();
    //        FacesMessage fm =
    //            new FacesMessage(FacesMessage.SEVERITY_ERROR, summary, dtl);
    ...
    public static void addFacesErrorMessageRedirect(String msg){
    ...
    public static String getRootViewComponentId() {
     ...
     FacesContext ctx = FacesContext.getCurrentInstance();
        ...
        String url = extContext.encodeActionURL(ctx.getApplication().getViewHandler().getActionURL(ctx, viewId));
        try {
...
//
//        public static void sendRedirect(String viewId) {
//            FacesContext fctx = JSFUtils.getFacesContext();
...
//        } 
    ...
    */
    ...
    private static ResourceBundle getBundle() {
        ...
        return ResourceBundle.getBundle("com.yemensoft.RemittanceBundle",
                                        locale, ldr);
    }
