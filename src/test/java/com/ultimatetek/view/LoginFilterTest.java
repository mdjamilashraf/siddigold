...
public class LoginFilterTest extends WebDriverTest {
	 ...
	 * driver.get("http://localhost:9090/tourtravels/login.xhtml");
	 * 
	 * LoginFilterPage page = new LoginFilterPage(driver); page.login("john.doe",
	 * "1234");
	 * 
	 * assertThat(page.getWelcomeMessage()) .isEqualTo("Welcome, John Doe!"); }
	 * 
	 * @Test public void testLoginFailed() {
	 * driver.get("http://localhost:9090/codenotfound/login.xhtml");
	 * 
	 * LoginFilterPage page = new LoginFilterPage(driver); page.login("jane.doe",
	 * "1234");
	 * 
